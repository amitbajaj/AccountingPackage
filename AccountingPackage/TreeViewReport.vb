...
Public Class TreeViewReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountingPackage.TreeViewReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTreeViewReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TreeViewReport = New TreeViewReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
